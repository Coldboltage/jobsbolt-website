        ...
        <div className="flex flex-row justify-end gap-4">
          {!job.interested ? (
            <>
              ...
              }} className="bg-red-400 text-white p-4 py-1 rounded w-auto inline-block text-[20px] font-bold">
                Not Interested
              </button>
              <button onClick={async () => {
              ...
              }} className="bg-green-400 text-white p-4 py-1 rounded w-auto inline-block text-[20px] font-bold">
                Interested
              </button>
