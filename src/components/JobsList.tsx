...
const JobsList = ({
  ...
  const [jobUrl, setJobUrl] = useState(`https://${process.env.NEXT_PUBLIC_CLIENT_API_URL}:3000/api/job/pending-interested`);
      ...
      <div className="max-w-screen-lg mx-auto">
        ...
        <div className="flex flex-wrap gap-6 mb-10 justify-center">
          <JobStage
            ...
            url={`https://${process.env.NEXT_PUBLIC_CLIENT_API_URL}:3000/api/job/pending-interested`}
            setJobUrl={setJobUrl}
